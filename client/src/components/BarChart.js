...
export default function BarChart(props){
    ...
    // Parse the Data
    const data=[
        {group: "Member1",tasks: "12",bugs: "1",issues: "13"},
        {group: "Member2",tasks: "16",bugs: "4",issues: "15"},
        {group: "Member3",tasks: "20",bugs: "2",issues: "11"},
    ]
    console.log(data);
    ...
    return(
        ...
        <Stack width="0.5" direction="row" alignContent="center">
            ...
            <svg id="barChart" width="100vh" height="500px"></svg>
        </Stack>
        </>
    );
}